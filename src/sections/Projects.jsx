...
const Projects = () => {
  ...
  const handleMouseMove = (event) =>{
    x.set(event.clientX - 80) // Adjust the offset as needed
    y.set(event.clientY - 80) // Adjust the offset as needed
  }
  ...
  return (
    <section onMouseMove={handleMouseMove} className='relative c-space section-spacing'>
      ...
      />))}
     { preview && ( <motion.img 
      className='fixed top-0 left-0 z-50 object-cover h-56 rounded-lg 
      shadow-lg pointer-events-none w-80'
      src={preview}
